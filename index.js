...
function createMenuItem(newName, priceMark, meal){
    return {name : newName, price : priceMark, category : meal,}
...
console.log(createMenuItem('Spaghetti', 9, 'Lunch'));
...
const burger = {
  ...
  discount: function(who){
    if(who === 'teacher' || who === 'student'){return this.price * 0.75} else if(who === 'public'){return this.price * .9} else {return this.price}
  },
